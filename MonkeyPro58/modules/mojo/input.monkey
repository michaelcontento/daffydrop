...
Class InputDevice="gxtkInput"
	...
	Method SetKeyboardEnabled( enabled )
...
Function JoyX#( index=0,unit=0 )
	Return device.JoyX( index | unit Shl 4 )
End

Function JoyY#( index=0,unit=0 )
	Return device.JoyY( index | unit Shl 4 )
End

Function JoyZ#( index=0,unit=0 )
	Return device.JoyZ( index | unit Shl 4 )
End

Function JoyDown( button,unit=0 )
	Return device.KeyDown( button | unit Shl 4 | KEY_JOY0 )
End

Function JoyHit( button,unit=0 )
	Return device.KeyHit ( button | unit Shl 4 | KEY_JOY0 )
End
...
Const KEY_TOUCH0 =$180		'32 touch states: $180-$19f
